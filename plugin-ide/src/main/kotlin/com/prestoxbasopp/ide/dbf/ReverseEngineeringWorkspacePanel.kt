...
class ReverseEngineeringWorkspacePanel(
    ...
    private fun populateTabs() {
        ...
        workflowTabs.addTab(ReverseEngineeringTab.Inputs.title, JBScrollPane(readOnlyArea(inputsSummary())))
        ...
        workflowTabs.addTab(ReverseEngineeringTab.ApiSurface.title, JBScrollPane(readOnlyArea(apiSummary())))
        workflowTabs.addTab(ReverseEngineeringTab.GenerationOutput.title, JBScrollPane(readOnlyArea(generationSummary())))
